...
public class Place_Order extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if(Customer.order(jTextField1.getText(), jTextField3.getText(), jTextField8.getText(), jTextField4.getText(), jTextField9.getText(), jTextField5.getText(), jTextField10.getText(), jTextField6.getText(), jTextField11.getText(), jTextField7.getText(), jTextField12.getText()))
            {
                JOptionPane.showMessageDialog(null, "Ordered Sucessfully.");
                new Customer_GUI().setVisible(true);
                this.dispose();
            }
            else
